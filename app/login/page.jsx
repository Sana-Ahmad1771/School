      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12 lg:p-24 bg-[#F8F9FB]">
        <div className="w-full max-w-md bg-white p-8 md:p-14 rounded-[2rem] md:rounded-[2.5rem] shadow-xl shadow-[#1F1A55]/5">
          ...
          >
            ...
            <button className="w-full bg-[#1F1A55] text-white py-4 md:py-5 rounded-full font-black uppercase tracking-[0.2em] text-[10px] flex items-center justify-center gap-4 hover:bg-[#9C1D20] shadow-lg transition-all group active:scale-95">
              Sign In
              <ArrowRight
                size={16}
