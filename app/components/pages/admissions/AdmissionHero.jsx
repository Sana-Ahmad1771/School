        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end w-full gap-8 lg:gap-10">
          ...
          <div className="select-none w-full lg:max-w-4xl">
            <div className="flex items-center gap-3 mb-4 md:mb-6">
              <span className="bg-[#FACC15] text-[#1F1A55] px-4 py-1 rounded-full text-[10px] md:text-xs font-black uppercase tracking-widest shadow-lg">
                Session 2026—2027
              </span>
            </div>
            ...
            <div className="lg:border-l-4 border-[#9C1D20] lg:pl-8">
              ...
              <div className="flex flex-col sm:flex-row lg:flex-col xl:flex-row gap-6 items-start sm:items-center lg:items-start xl:items-center">
                <button
                  ...
                  className="w-full sm:w-auto bg-[#9C1D20] hover:bg-[#b32427] text-white px-8 py-4 rounded-full font-bold transition-all flex items-center justify-center gap-2 group text-xs uppercase tracking-wider shadow-xl shadow-black/20 active:scale-95"
                >
                  Start Application
                  <ClipboardCheck
                    size={18}
