      ...
      <div className="max-w-[1800px] mx-auto px-8 lg:px-10">
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="lg:w-1/3 w-full sticky top-32">
            ...
            <h2 className="text-[40px] md:text-[55px] font-bold text-[#1F1A55] leading-[1] tracking-tighter mb-8">
              What You <br /> <span className="text-[#9C1D20]">Need To</span> Prepare.
            </h2>
            
            {/* Contact Support Box */}
            <div className="bg-[#F8F9FB] p-8 rounded-[2rem] border border-gray-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-[#1F1A55]">0340-9003875</p>
                </div>
              </div>
              ...
              <Link href="/signup">
                <button className="w-full bg-[#1F1A55] text-white py-4 rounded-full font-black uppercase tracking-widest text-[10px] flex items-center justify-center gap-3 hover:bg-[#9C1D20] transition-all group shadow-lg shadow-[#1F1A55]/20">
                  Apply Online Now
          ...
          <div className="lg:w-2/3 w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {documents.map((doc, index) => (
                <div 
                  key={index} 
                  className="group p-8 rounded-[2.5rem] border-2 border-gray-50 hover:border-[#9C1D20]/10 hover:bg-gray-50 transition-all duration-500"
                >
                  ...
                  <h3 className="text-xl font-bold text-[#1F1A55] mb-3 uppercase tracking-tight">
                    {doc.title}
                  </h3>
            ...
            {/* Note Area */}
            <div className="mt-10 p-8 rounded-[2rem] border-2 border-dashed border-gray-200 flex items-start gap-4">
               <div className="min-w-[10px] h-10 w-1 bg-[#FACC15] rounded-full mt-1" />
               <p className="text-sm text-gray-400 font-medium">
                 <span className="text-[#1F1A55] font-bold">Important Note:</span> All photocopies must be clearly legible. Original documents must be presented at the time of the final interview for physical verification.
               </p>
            </div>
          </div>
